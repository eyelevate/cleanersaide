...
var addOnsUs = function(num) {
	...
	if(addOnLength >0){
		...
		$("#hotelAddOnTbody tr").each(function(idx){
			...
			var price = $(this).find(".hotelAddOnNet").val();
			...
			addOns = addOns+
				'<tr num="'+num+'" idx="'+idx+'">'+
					...
					'<td class="addOnActiveRow-net">US$'+price+' <input class="inventoryAddOnsNet" type="hidden" name="data[Hotel_room]['+num+'][add_ons]['+idx+'][net]" value="'+price+'"/></td>'+
					'<td class="addOnActiverow-markup">'+markup+'% <input class="inventoryAddOnMarkup" type="hidden" name="data[Hotel_room]['+num+'][add_ons]['+idx+'][markup]" value="'+markup+'"/>'+
					'<td class="addOnActiveRow-gross">US$'+gross+' <input class="inventoryAddOnGross" type="hidden" name="data[Hotel_room]['+num+'][add_ons]['+idx+'][gross]" value="'+gross+'"/></td>'+
					...
					//''<td><button class="deleteAddOn btn btn-small" type="button"><i class="icon-calendar"></i></button></td>'+
				'</tr>';
		});	
		var tableAddOnStart = 
		...
		$("#hotelAddOnTbody tr").each(function(idx){
			...
			addOns = addOns+
				'<tr num="'+num+'" idx="'+idx+'">'+
					...
					'<td class="addOnActiveRow-markup">'+markup+'% <input class="invnentoryAddOnMarkup" type="hidden" name="data[Hotel_room]['+num+'][add_ons]['+idx+'][markup]" value="'+markup+'"/></td>'+
					...
					'<td class="addOnActiveRow-perbasis">'+per_basis+' <input class="inventoryAddOnsPerBasis" type="hidden" name="data[Hotel_room]['+num+'][add_ons]['+idx+'][per_basis]" value="'+per_basis+'"/></td>'+
					//'<td><button class="deleteAddOn btn btn-small"><i class="icon-calendar"></i></button></td>'+
				'</tr>';
		});	
		var tableAddOnStart = 
			'<table class="table table-bordered table-condensed table-hover">'+
	...
	var room = 
		'<div class="accordion-group" style="background:#fff;">'+
			'<div class="accordion-heading" name="hotelRoom">'+
				'<a class="'+attribute+'" data-toggle="collapse" data-parent="#accordionRoomType" href="#roomType'+num+'"><h4>Room Name: <span id="roomTypeSpan-'+num+'" class="roomTypeSpan">'+(num+1)+'</span> <span id="roomTypeLabel-'+num+'" class="roomTypeLabel"></span></h4></a>'+
			'</div>'+
			'<div id="roomType'+num+'" class="'+attribute2+'">'+
					...
					'<div id="hotelRoomInventoryDiv-'+num+'">'+
						'<div class="formSep">'+
							...
							'<div class="form-horizontal">'+
								'<div class="control-group">'+				
									...
									'<div class="controls">'+
										'<input id="Hotel_room'+num+'Name" class="hotelRoomName span6" dataRow="'+num+'" type="text" placeholder="enter a hotel room type" name="data[Hotel_room]['+num+'][name]">'+						
								...
								'<div class="control-group">'+
									...
									'<div class="controls">'+
									'<select id="HotelRoom'+num+'Status" name="data[Hotel_room]['+num+'][status]">'+
								...
								'<div class="control-group">'+
									...
									'<div class="controls">'+
										'<div class="input-prepend">'+
											'<span class="add-on">#</span>'+
											'<input id="Hotel_room'+num+'OccupancyBase" class="hotelOccupancyBase" dataRow="'+num+'" type="text" value="2" name="data[Hotel_room]['+num+'][occupancy_base]">'+
										'</div>'+
										'<span class="help-inline"></span>'+
									'</div>'+
								'</div>'+
								'<div class="control-group">'+
									...
									'<div class="controls">'+
										'<div class="input-prepend">'+
											'<span class="add-on">#</span>'+
											'<input id="Hotel_room'+num+'OccupancyMax" class="hotelOccupancyMax" dataRow="'+num+'" type="text" value="4" name="data[Hotel_room]['+num+'][occupancy_max]">'+
										'</div>'+
										'<span class="help-inline"></span>'+
									'</div>'+
								'</div>'+
								...
								'<div class="control-group">'+
									...
									'<div class="controls">'+
										'<div class="input-append">'+
											...
											'<span class="add-on">%</span>'+
										'</div>'+
										'<input id="taxrate-'+num+'" class="taxrate" type="hidden" name="data[Hotel_room]['+num+'][tax_rate]" value=""/>'+
									'</div>'+
								'</div>'+
							'</div>'+
						'</div>'+
						...
						'<div class="formSep clearfix">'+
							...
							'<table class="table table-condensed table-bordered table-striped table-vam">'+
								...
								'<tbody id="roomInventoryTbody-'+num+'">'+
									'<tr>'+	
										'<td class="control-group">'+
											'<div class="input-append">'+
												'<input id="HotelRoom'+num+'Inventory0StartDate" class="blockBeginDate" type="text" placeholder="mm/dd/yyyy" name="data[Hotel_room]['+num+'][Inventory][0][start_date]" style="width:100px;">'+
										...
										'<td class="control-group">'+
											'<div class="input-append">'+
												'<input id="HotelRoom'+num+'Inventory0EndDate" class="blockEndDate" type="text" placeholder="mm/dd/yyyy" name="data[Hotel_room]['+num+'][Inventory][0][end_date]" style="width:100px;">'+
										...
										'<td class="control-group">'+
											'<div class="input-prepend">'+
												'<span class="add-on">#</span>'+
												'<input id="HotelRoom'+num+'Inventory0Total" class="roomBlockTotal" type="text" name="data[Hotel_room]['+num+'][Inventory][0][total]" style="width:75px;">'+
											'</div>'+
											'<span class="help-block"></span>'+																											
										'</td>'+							
										'<td class="control-group">'+
											'<div class="input-prepend">'+
												'<span class="add-on">US$</span>'+
												'<input id="Hotel_room'+num+'Inventory0Net" class="inventoryNetRate" type="text" name="data[Hotel_room]['+num+'][Inventory][0][net]" value="0" style="width:75px;">'+	
											'</div>'+
											'<span class="help-block"></span>'+		
										...
										'<td class="control-group">'+
											'<div class="input-append">'+
												'<input id="Hotel_room'+num+'Inventory0Markup" class="inventoryMarkupRate" type="text" name="data[Hotel_room]['+num+'][Inventory][0][markup]" value="0" style="width:75px;">'+	
												'<span class="add-on">%</span>'+
											'</div>'+
											'<span class="help-block"></span>'+																									
										'</td>'+
										'<td class="control-group">'+
											'<div class="input-prepend">'+
												'<span class="add-on">US$</span>'+
												'<input id="Hotel_room'+num+'Inventory0Gross" class="inventoryGrossRate" type="text" name="data[Hotel_room]['+num+'][Inventory][0][gross]" value="0" style="width:75px;">'+
											'</div>'+
											'<span class="help-block"></span>'+													
										'</td>'+
									'</tr>'+
							...
							'<div class="pull-right">'+
								'<button type="button" id="addRoomInventory-'+num+'" class="btn btn-primary">Add New Schedule</button>'+
							'</div>'+
						'</div>'+
						'<div class="formSep clearfix">'+
						...
						'<div class="formSep" style="height:40px;">'+
							'<button id="removeRoomButton-'+num+'" type="button" class="removeRoomButton btn btn-danger btn-large pull-right">Remove Hotel Room</button>'+
						'</div>'+
					'</div>'+
				'</div>'+
			'</div>'+
							...
							'<div class="form-horizontal">'+
								...
								'<div class="well well-small">'+
									...
									'<div class="control-group">'+
										...
										'<div class="controls">'+
											'<div class="input-append">'+
												'<input id="Hotel_room'+num+'ExchangeRate" class="hotelPlusFeeExchangeRate span6" dataRow="'+num+'" value="'+exRate+'" type="text" name="data[Hotel_room]['+num+'][exchange_rate]" disabled="disabled">'+
									...
									'<tr>'+	
										...
										'<td class="control-group">'+
											'<div class="input-prepend input-append">'+
												...
												'<input id="Hotel_room'+num+'Inventory0Net" class="inventoryNetRate" type="text" name="data[Hotel_room]['+num+'][Inventory][0][net]" value="0" style="width:75px;">'+	
												'<span id="Hotel_room'+num+'Inventory0ChangeCurrency" class="changeCurrencyStatus add-on btn btn-link" status="canusd">Change</span>'+
											'</div>'+
											'<span class="help-block"></span>'+		
											//'<input id="Hotel_room'+num+'Inventory0Net" class="inventoryNetRate" type="hidden" name="data[Hotel_room]['+num+'][Inventory][0][net]" value="0">'+																							
										'</td>'+
										'<td class="control-group">'+
											'<div class="input-append">'+
												'<input id="Hotel_room'+num+'Inventory0ExchangeRate" class="inventoryExchangeRate" type="text" name="data[Hotel_room]['+num+'][Inventory][0][exchange_rate]" disabled="disabled" style="width:75px;" value="'+exRate+'">'+	
		...
		'<tr>'+	
			...
			'<td class="control-group">'+
				'<div class="input-prepend input-append">'+
					...
					'<span id="Hotel_room'+idx+'Inventory'+num+'ChangeCurrency" class="changeCurrencyStatus add-on btn btn-link" status="canusd">Change</span>'+
				'</div>'+
				'<span class="help-block"></span>'+																									
			'</td>'+
			'<td class="control-group">'+
				'<div class="input-append">'+
					'<input id="Hotel_room'+idx+'Inventory'+num+'ExchangeRate" class="inventoryExRate" type="text" name="data[Hotel_room]['+idx+'][Inventory]['+num+'][exchange_rate]" value="'+exchange+'" disabled="disabled" style="width:75px;">'+	
					'<span class="add-on">CAN/USD</span>'+
				'</div>'+
				'<span class="help-block"></span>'+											
			'</td>'+
...
var newRoomMarketing = function(num){
	var roomMarketing = 
		'<div id="marketingRoom-'+num+'" class="accordion-group">'+
			'<div class="accordion-heading">'+
				'<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion4" href="#room-'+num+'"><h4 id="hotelRoomName-'+num+'"></h4></a>'+
			'</div>'+
			'<div id="room-'+num+'" class="accordion-body collapse">'+
					...
					'<div id="hotel_room_marketing-'+num+'">'+
						...
						'<div class="formSep">'+
							...
							'<div class="control-group">'+
								...
								'<textarea name="data[Hotel_room]['+num+'][room_description]" class="span6" rows="5" cols="30"></textarea>'+
								'<span class="help-block"></span>'+
							'</div>'+	
						'</div>'+			
					'</div>'+
	...
	var tax =
		'<div class="taxesRatesDivs alert alert-info" style="margin-bottom:2px;">'+
			...
			'<div class="controls">'+
				...
				'</div>'+
				'<input type="hidden" name="data[Hotel_room]['+idx+'][taxes]['+tax_id+']" value="'+tax_id+'"/>'+
			'</div>'+
	...
	tr = 
		'<tr id="hotelAddOnTr-0" class="hotelAddOnTr">'+
			...
			'<td class="control-group">'+
				'<div class="input-prepend">'+
					'<span class="add-on">US$</span>'+
					'<input id="hotelAddOnPrice-0" class="hotelAddOnNet" type="text" name="data[Hotel][add_ons][0][net]" value="0" style="width:75px"/>'+
				'</div>'+
			'</td>'+
			'<td class="control-group">'+
				'<div class="input-append">'+
					'<input class="hotelAddOnMarkup" type="text" name="data[Hotel][add_ons][0][markup]" style="width:75px;"/>'+
					'<span class="add-on">%</span>'+
				'</div>'+
			'</td>'+
			'<td class="control-group">'+
				'<div class="input-prepend">'+
					'<span class="add-on">US$</span>'+
					'<input class="hotelAddOnGross" type="text" name="data[Hotel][add_ons][0][gross]" style="width:75px;"/>'+
				'</div>'+
			'</td>'+	
	...
	tr = 
		'<tr id="hotelAddOnTr-0" class="hotelAddOnTr">'+
			...
			'<td class="control-group">'+
				'<div class="input-prepend">'+
					'<span class="add-on">CN$</span>'+
					'<input class="hotelAddOnNet" type="text" name="data[Hotel][add_ons][0][net]" style="width:75px" value=""/>'+
				'</div>'+
			'</td>'+
			'<td class="control-group">'+
				'<div class="input-append">'+
			...
			'<td class="control-group">'+
				'<div class="input-prepend">'+
					'<span class="add-on">US$</span>'+
					'<input class="hotelAddOnGross" type="text" name="data[Hotel][add_ons][0][gross]" style="width:75px" value=""/>'+
				'</div>'+
			'</td>'+
			'<td id="hotelRadioTr" class="form-inline">'+
