      ...
      , methods = {
        init: function (opt) {
          this.each(function () {
              ...
              $spanLeft = $('<span></span>').addClass("labelLeft").text(options.label.enabled === undefined ? "SHOW" : options.label.enabled);
              $spanRight = $('<span></span>').addClass("labelRight").text(options.label.disabled === undefined ? "HIDE" : options.label.disabled);
