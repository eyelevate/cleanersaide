...
closeESC:!0,closeCookie:!1,cookieSettings:{path:"/",expires:0},imagePath:"/js/frontend/plugins/jReject/images/",overlayBgColor:"#000",overlayOpacity:0.8,fadeInTime:"fast",fadeOutTime:"fast",analytics:!1},f);1>a.display.length&&(a.display="firefox chrome msie safari opera gcf".split(" "));b.isFunction(a.beforeReject)&&a.beforeReject();a.close||(a.closeESC=!1);f=function(a){return(a.all?!0:!1)||(a[b.os.name]?!0:!1)||(a[b.layout.name]?!0:!1)||(a[b.browser.name]?!0:!1)||(a[b.browser.className]?!0:!1)};if(!f(a.reject)){if(b.isFunction(a.onFail))a.onFail();
