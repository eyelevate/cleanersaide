...
/**
 * Place for all raw static byte conversion functions.  Expecially useful for converting
 * typed Hex (<code>String</code> base 16) to <code>byte[]</code>, <code>byte[]</code> 
 * to Hex (<code>String</code> base 16), <code>byte[]</code> to <code>int[]</code>
 * conversions, etc.
 * @author Tres Finocchiaro
 */
public class ByteUtilities {
     ...
     * <code>pattern</code> <code>byte[]</code> array and <code>count</code>, this
     * returns a <code>LinkedList</code> of <code>byte[]</code> split at the
     * nth instance of the supplied <code>pattern</code>. (nth being the supplied
     * <code>count</code> parameter)
     * 
     * This is useful for large print batches that need to be split up (for example)
     * after the P1 or ^XO command has been issued.
     * 
     * TODO: A rewrite of this would be a proper <code>Iteratable</code> interface
     * paired with an <code>Iterator</code> that does this automatically and would
     * eliminate the need for a <code>indicesOfSublist()</code> function.
     * 
     * @param src
     * @param pattern
     * @param count
     ...
     * integers (<code>int[]</code>).  These integers will likely be converted
     * to a byte array (<code>byte[]</code>) later.
     * @param black
     * @return 
     */
    ...
    /**
     * Alternative to getHex(). Not used.
     * Converts a <code>byte[]</code> to a Hexadecimal (base 16) String 
     * representation. i.e. { 0x1B, 0x00 } would look like this:  "1B00"
     * @param b
     * @return
     * @throws Exception 
     */
