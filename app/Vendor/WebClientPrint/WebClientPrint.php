...
WebClientPrint::$webClientPrintAbsoluteUrl = $_SERVER['DOCUMENT_ROOT'].'/app/Vendor/WebClientPrint/WebClientPrint.php';
//Set wcpcache folder RELATIVE to WebClientPrint.php file
//FILE WRITE permission on this folder is required!!!
WebClientPrint::$wcpCacheFolder = $_SERVER['DOCUMENT_ROOT'].'/app/tmp/cache/wcpcache/';
//===================
