...
$confirmation_address = 'http://www.cohoferry.com/hotels/update_confirmation/';
$confirmation_address .=  $confirmation_id;
$confirmation_address .= '/'.$hotel_id;
if(!empty($hotel_reservation_id)){
	$confirmation_address .= '/'.$hotel_reservation_id;
}
?>
      ...
      <table cellpadding="0" width="600" cellspacing="0" style="border: 1px solid #AAA;">
        ...
        <tr>
          <td class="main" style="background-color: #ffffff;  color: #000000; font-family: arial; font-size: 12px; line-height: 150%; padding: 2px 18px;" bgcolor="#ffffff" valign="top" align="left">
			<p style="color: #333333; font-family: arial,sans-serif; font-size: 15px; line-height: 130%; margin: 25px;"><?php echo substr($full_name, 0, -1);?> has made a reservation for your hotel with Black Ball Ferry Line. Their BBFL confirmation is: <?php echo $confirmation_id;?>. <br> For more details and to enter your hotel's confirmation code, please go to: <a href="<?php echo $confirmation_address;?>"><?php echo $confirmation_address;?></a></p>
