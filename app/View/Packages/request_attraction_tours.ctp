...
if($_REQUEST['attraction_id'] && $_REQUEST['start']){
	...
	if(count($tour_rates)>0){
		...
		if($time > 0 && $notime == 0 || $time > 0 && $notime > 0){
			...
			?>
			<li id="timedToursDiv" class="twelve columns alpha well well-large clearfix" style="padding-right:0px; padding-left:0px;">
								...
								<li id="tourLi-<?php echo $tour_id;?>" time="<?php echo $tour_time;?>"  class="tourLi twelve columns alpha " <?php echo $tour_hide.$timedLi;?> title="<?php echo $title;?>">
									...
									<div class="ten columns omega" >
										<div class="seven columns alpha">
											...
											<!-- tour ticketing -->
											<div id="tourAmountDiv" class="well well-small clearfix">
												<label><strong>Enter in ticket quantities <span class="f_req">*</span></strong></label>
											<?php
														...
														if($tour_time == $time){
															foreach ($tour_inventory[$tiKey] as $t) {
																...
																<div class="control-group pull-left span3">
																	<label><?php echo $age_range;?></label>
																	<input type="text" class="typePrice span12" name="data[Attraction_reservation][purchase_info][<?php echo $age_range;?>][amount]" age_range="<?php echo $age_range;?>" reserved="<?php echo $reserved;?>" inventory="<?php echo $inventory_limit;?>" tax_rate="<?php echo ($tax_rate/100); ?>" gross="<?php echo $gross;?>" value="0"/>
																	<span class="help-block"></span>
											...
											<div class="control-group six columns alpha">
												<button id="bookTour-<?php echo $tour_id;?>" class="bookTour <?php echo $disabled;?> btn" time="<?php echo $time;?>"  date="<?php echo $date;?>" type="button" disabled="disabled">Confirm</button>	
											</div>	
											</div>						
										</div>
										...
										<div class="three columns omega pull-right">
											<ul>
												...
												<!-- <li>
													<button id="bookTour-<?php echo $tour_id;?>" class="bookTour <?php echo $disabled;?> btn btn-success btn-block" type="button" time="<?php echo $time;?>"  date="<?php echo $date;?>" disabled="disabled">SELECT TOUR</button>
												</li> -->
											</ul>
										</div>
									</div>
